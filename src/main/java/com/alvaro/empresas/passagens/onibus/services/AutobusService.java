...
import com.alvaro.empresas.passagens.onibus.dtos.autobuses.AutobusDTOResponse;
import com.alvaro.empresas.passagens.onibus.dtos.autobuses.AutobusDTOUpdate;
...
public class AutobusService {
    ...
    public void delete(AutobusModel model) {
        ...
        Page<ViagemModel> viajesFuturos = viajeRepository.findAfterDate(model.getEmpresa().getId(), now, pageable);
        ...
        if (viaje.isEmpty())
            ...
            throw new RestRuntimeException(HttpStatus.BAD_REQUEST, "El atobus tiene un viaje programado en el futuro");
    }
}
