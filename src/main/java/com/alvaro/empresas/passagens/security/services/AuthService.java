...
public class AuthService {
    ...
    public void registrar(RegisterDTO registerDto) {
        ...
        var solicitacoes = usuarioSolicitacaoRepository.findByEmailAfterTime(registerDto.login(), inicioDoDia, TipoSolicitacao.CREATE);
        ...
        UsuarioSolicitacaoModel novoUsuario = new UsuarioSolicitacaoModel(registerDto.login(), registerDto.nome(), registerDto.telefone(), senhaCriptografada, TipoSolicitacao.CREATE);
